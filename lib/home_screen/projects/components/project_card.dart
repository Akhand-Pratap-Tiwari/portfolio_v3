...
class _ProjectCardState extends State<ProjectCard> {
  ...
  ValueNotifier<Offset> pOffset = ValueNotifier(
                    ...
                    Container(
                      decoration: BoxDecoration(
                        ...
                        gradient: RadialGradient(
                          ...
                          colors: [
                            Colors.cyanAccent,
                            isHovering ? Colors.black : Colors.transparent
                          ],
                          stops: const [0.1, 1],
                          center: Alignment(
...
class CardForeground extends StatelessWidget {
  ...
  Future<void> _showMyDialog(context, Project project) async {
            ...
            Align(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => _showMyDialog(context, project),
                    child: const Text(
                      "Read More >>",
